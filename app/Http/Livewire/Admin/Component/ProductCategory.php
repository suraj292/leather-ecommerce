...
class ProductCategory extends Component
{
    ...
    public function submit(){
        $this->validate();
        $new_category = product_category::create(['product_category'=>$this->newCategory]);
    ...
    public function update(){
        $this->validate(['editCategory' => ['required', 'unique:product_category,product_category'],]);
        $this->getCategory->update(['product_category'=>$this->editCategory]);
